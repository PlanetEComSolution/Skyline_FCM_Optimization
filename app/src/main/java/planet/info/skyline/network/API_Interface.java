...
public interface API_Interface {
   ...
   /* @POST("ClientJob/GetSwoByJob")
    ...
    @POST("TaskPlanning/BindTaskListByEmployeeID")  // dev
    Observable<List<MyTask>> GetTaskListByEmployeeID(@Body HashMap<String, String> body);

    @POST("TaskPlanning/SaveJobChecklist1X") // dev
    Observable<List<SavChecklist>> SaveChecklist(@Body HashMap<String, String> body);
