...
public class Shared_Preference {
    ...
    private static final String KEY_TASK_PRIMARY_ID = "Task_PRIMARY_Id";
    private static final String KEY_TASK_LABOR_ID = "Task_LABOR_Id";
    private static final String KEY_JOB_STARTED_FROM_MY_TASK = "JOB_STARTED_FROM_MY_TASK";
    ...
    public static void set_Task_ID(Context context, String job_id) {
        try {

            SharedPreferences.Editor editor = getSharedPreferences(context).edit();
            editor.putString(KEY_TASK_ID, job_id);
            editor.apply();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    public static String get_Task_ID(Context context) {
        String val = "";
        try {

            val = getSharedPreferences(context).getString(KEY_TASK_ID, "");
            return val;
    ...
    public static void set_Task_PrimaryID(Context context, String job_id) {
        try {
            SharedPreferences.Editor editor = getSharedPreferences(context).edit();
            editor.putString(KEY_TASK_PRIMARY_ID, job_id);
            editor.apply();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    public static String get_Task_PrimaryID(Context context) {
        String val = "";
        try {

            val = getSharedPreferences(context).getString(KEY_TASK_PRIMARY_ID, "");
            return val;
    ...
    public static void set_Task_LaborId(Context context, String task_labor_id) {
        try {
            SharedPreferences.Editor editor = getSharedPreferences(context).edit();
            editor.putString(KEY_TASK_LABOR_ID, task_labor_id);
            editor.apply();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    public static String get_Task_LaborId(Context context) {
        String val = "";
        try {

            val = getSharedPreferences(context).getString(KEY_TASK_LABOR_ID, "");
            return val;
    ...
    public static void set_JobStartedFromMyTask(Context context, boolean isJobStartedFromMyTask) {
        try {
            SharedPreferences.Editor editor = getSharedPreferences(context).edit();
            editor.putBoolean(KEY_JOB_STARTED_FROM_MY_TASK, isJobStartedFromMyTask);
            editor.apply();
        } catch (Exception e) {
            e.printStackTrace();
        }
    }
    public static boolean get_JobStartedFromMyTask(Context context) {
        Boolean val = false;
        try {

            val = getSharedPreferences(context).getBoolean(KEY_JOB_STARTED_FROM_MY_TASK, false);
            return val;
