    ...
    private void getIntentData() {
        ...
        try {
            ...
            if (deadlineDate == null || deadlineDate.trim().equals("")) {
                ...
                deadline_date.setText(Utility.ChangeDateFormat("yyyy-MM-dd", "dd MMM yyyy", deadlineDate.trim()));
            }
            ...
            if (startBy == null || startBy.trim().equals("")) {
                ...
                Start_By.setText(Utility.ChangeDateFormat("yyyy-MM-dd", "dd MMM yyyy", startBy.trim()));
            }
